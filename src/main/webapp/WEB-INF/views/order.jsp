		...
		<div class="wrap">
			<div class="top_gnb_area">
				<ul class="list">
					...
					<c:if test="${member != null }">
						...
						<li><a id="gnb_logout_button">로그아웃</a><a href="/member/logout.do">로그아웃</a></li>
						<li>마이룸</li>
			...
			<div class="content_area">
				...
				<div class="content_main">
					...
					<!-- 배송지 정보 : 기존 회원가입 때 정보 선택 or 새로 입력 -->
...
<script>
$(document).ready(function(){ // '주문 페이지' 진입 시, 상품정보 세팅
